...
#define LCD_LED_GPIO_Port 	GPIOF
#define LCD_LED_OFF			HAL_GPIO_WritePin(LCD_LED_GPIO_Port,LCD_LED,GPIO_PIN_RESET);
#define LCD_LED_ON			HAL_GPIO_WritePin(LCD_LED_GPIO_Port,LCD_LED,GPIO_PIN_SET);
